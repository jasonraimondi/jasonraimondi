...
- [jasonraimondi/tsconfig](https://github.com/jasonraimondi/tsconfig) - Provides generic esm tsconfig files to extend from. tsconfig.strict.json, tsconfig.node.json, tsconfig.browser.json _(1 month ago)_
