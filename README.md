...
- [jasonraimondi/playwright-browser-pool](https://github.com/jasonraimondi/playwright-browser-pool) - A template repository to spawn playwright browsers in a generic pool. For science. _(3 weeks ago)_
