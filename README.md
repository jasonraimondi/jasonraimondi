...
- [jasonraimondi/date-duration](https://github.com/jasonraimondi/date-duration) - The DateDuration class represents a duration of time specified in milliseconds. It provides methods to calculate and retrieve information about the duration. _(6 days ago)_
